...
import { Chevron, Date, Email, Phone, Save, Sex, Telegram } from '../../../Styles/Icon';
...
const EditProfile = () => {
  ...
  console.log('DataOutFunction', data);
                ...
                <View style={{ marginTop: -35, height: h / 2.8 }}>
                  <View style={{ flexDirection: 'row' }}>
                    <TextInput
                      ...
                      style={{ color: 'white', fontSize: 20, fontWeight: 'bold', width: 360 }}
                    >
                      {data?.Name}
                    </TextInput>
                  ...
                  <View style={{ width: w, height: 30 }}>
                    <TextInput style={styles.text}>{data?.Username}</TextInput>
                  </View>
                  ...
                  <View style={{ height: h, marginVertical: 20 }}>
                    ...
                    <View style={{ marginTop: 5 }}>
                      <TextInput style={{ color: 'gray' }} multiline={true} numberOfLines={4}>
                  ...
                  <View style={styles.fromtable1}>
                    ...
                    <View style={{ paddingHorizontal: 10, marginTop: 2 }}>
                      ...
                      <View style={{ width: 110 }}>
                        <TextInput numberOfLines={1}>{data?.Mail}</TextInput>
                      </View>
                    </View>
                  </View>
